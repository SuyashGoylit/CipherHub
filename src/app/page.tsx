      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gray-50 rounded-xl p-6 shadow-lg mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-gray-800">About CipherHub</h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <Link href="/classical" className="group">
            <div className="bg-gray-50 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-800">Classical Ciphers</h3>
              </div>
          ...
          <Link href="/aes" className="group">
            <div className="bg-gray-50 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-800">Modern Cryptography</h3>
              </div>
              <p className="text-gray-600">
          ...
          <Link href="/sha" className="group">
            <div className="bg-gray-50 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-800">Hash Functions</h3>
              </div>
              <p className="text-gray-600">
          ...
          <div className="bg-gray-50 rounded-xl p-6 shadow-lg">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800">Learn More</h3>
            </div>
            <p className="text-gray-600">
